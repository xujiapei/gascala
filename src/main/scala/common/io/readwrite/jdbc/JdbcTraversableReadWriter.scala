package common.io.readwrite.jdbc

import java.util.Date

import common.io.{ReadWriteConf, SaveMode, TraversableReadAble, TraversableWriteAble}
import common.scalikejdbc.{ScalikejdbcConf, ScalikejdbcContext}
import common.utils.patterns.UsingPattern
